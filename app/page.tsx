...
import { Mail, Phone, Globe, Github, Linkedin, Twitter, FileText, ExternalLink } from "lucide-react"
      ...
      <section className="mx-auto w-full max-w-2xl space-y-8">
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex-1 space-y-1.5">
            ...
            <p className="max-w-md text-pretty font-mono text-sm text-muted-foreground">
              Full Stack Developer and DevOps Engineer focused on learning through experimentation and product
              development.
            </p>
            ...
            <div className="flex gap-x-1 pt-1 font-mono text-sm text-muted-foreground">
              ...
              <Button
                ...
                className="transition-all duration-300 hover:scale-110 hover:bg-accent hover:-rotate-6 bg-transparent"
              >
                <Link href="https://drive.google.com/file/d/1RhUOmZYX0BzLzuJ64riEfURGKYAWvBEN/view" target="_blank">
          ...
          <Avatar className="size-28 rounded-lg transition-all duration-500 hover:scale-110 hover:rotate-3 hover:shadow-xl">
            <AvatarImage src="/professional-developer-portrait.png" alt="Jatin Kashyap" />
        ...
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <p className="text-pretty font-mono text-sm text-muted-foreground leading-relaxed">
            Passionate Software Developer with a strong foundation in full-stack development and DevOps practices.
            Proven track record in designing and implementing scalable, resilient, and user-centric applications. Adept
            at leveraging modern technologies to solve complex problems and deliver impactful solutions. Currently
            enrolled in Cohort 3.0 under Harkirat, while learning Solana and Ethereum wallet development.
          </p>
        </section>
...
<Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50">
  <CardHeader>
    <div className="flex items-center justify-between gap-x-2">
      <CardTitle className="text-base">
        ...
        <Badge variant="secondary" className="ml-2">Software Developer</Badge>
        <Badge variant="secondary" className="ml-1">On-site</Badge>
      </CardTitle>
  ...
  <CardContent>
    <ul className="text-pretty font-mono text-xs text-muted-foreground list-disc ml-4 space-y-1">
      ...
      <li>
        ...
        from scratch using Node.js, React.js, and MongoDB — 100% production-ready.
      </li>

      <li>
        Integrated WhatsApp API notifications and automated workflows,
        improving user engagement by <strong>35%</strong> and reducing manual communication by <strong>60%</strong>.
      </li>

      <li>
        Implemented Docker-based CI/CD pipelines, achieving <strong>40% faster deployments</strong> and
  ...
  <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50">
    <CardHeader>
      <div className="flex items-center justify-between gap-x-2">
        <CardTitle className="text-base">
          ...
          <Badge variant="secondary" className="ml-2">Open Source Contributor</Badge>
        </CardTitle>
        <span className="text-sm tabular-nums text-muted-foreground">Jan 2025 – Apr 2025</span>
      </div>
      <CardDescription className="font-mono text-sm">
    ...
    <CardContent>
      <p className="text-pretty font-mono text-xs text-muted-foreground">
        Contributed to 8+ PRs (Redux refactor, Docker fixes, accessibility, auto-save). 
        Reviewed PRs, triaged issues, discussed designs with maintainers, and proposed 
        ideas later submitted as a GSoC 2025 project.
      </p>
    </CardContent>
  </Card>
  ...
  <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50">
    <CardHeader>
      <div className="flex items-center justify-between gap-x-2">
        <CardTitle className="text-base">
          ...
          <Badge variant="secondary" className="ml-2">Full Stack Developer</Badge>
        </CardTitle>
        <span className="text-sm tabular-nums text-muted-foreground">Apr 2025 – Aug 2025</span>
      </div>
      <CardDescription className="font-mono text-sm">
    ...
    <CardContent>
      <p className="text-pretty font-mono text-xs text-muted-foreground">
        Built a full-stack logistics platform with AWB & shipping label generation, courier API 
        integration, and admin dashboard. Developed REST APIs (Node.js, Express), improving 
        data processing speed by 25%. Deployed to production at shipduniya.in handling 
  ...
  <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50">
    <CardHeader>
      <div className="flex items-center justify-between gap-x-2">
        <CardTitle className="text-base">
          ...
          <Badge variant="secondary" className="ml-2">Open Source Developer</Badge>
        </CardTitle>
        <span className="text-sm tabular-nums text-muted-foreground">Aug 2024 – Dec 2025</span>
      </div>
      <CardDescription className="font-mono text-sm">
    ...
    <CardContent>
      <p className="text-pretty font-mono text-xs text-muted-foreground">
        Collaborated on real-world MERN projects, strengthened Git/GitHub workflows, debugging 
        techniques, testing, and component design. Completed weekly challenges & code reviews; 
            ...
            {[
              {
                ...
                tags: ["TurboRepo", "Node.js", "Express.js", "Prisma", "Docker", "Nodemailer", "API Monitoring"],
              },
              {
                title: "ShipDuniya",
                ...
                tags: ["Full Stack", "Node.js", "Express.js", "React", "MongoDB", "Docker", "GCP", "PM2"],
              },
              
              {
                ...
                tags: ["Node.js", "Selenium", "Whisper AI", "ffmpeg", "MongoDB", "REST API", "Next.js"],
              },
              {
                title: "Jobify",
                ...
                tags: ["MERN Stack", "Job Portal", "Node.js", "Express.js", "MongoDB", "React", "Redux"],
              },
              {
                title: "iPhone 3D",
                ...
                tags: ["3D Frontend", "GSAP", "Three.js", "React", "JavaScript", "Tailwind CSS", "Animation"],
              },
              {
                title: "Cravee",
                ...
                tags: ["Full Stack", "MERN", "MongoDB", "React", "Node.js", "Express.js", "Redux Toolkit"],
              },
              // {
              //   title: "Web3 Wallet",
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="font-mono text-xs line-clamp-3">{project.description}</CardDescription>
                </CardHeader>
        ...
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50">
            <CardHeader>
              <div className="flex items-center justify-between gap-x-2">
                <CardTitle className="text-base">University School Of Information Communication & Technology</CardTitle>
                <span className="text-sm tabular-nums text-muted-foreground">2023 - 2027</span>
              </div>
              <CardDescription className="font-mono text-sm">
          ...
          <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50">
            <CardHeader>
              <div className="flex items-center justify-between gap-x-2">
                <CardTitle className="text-base">SBV East Vinod Nagar, Delhi – 110091</CardTitle>
                <span className="text-sm tabular-nums text-muted-foreground">2023</span>
              </div>
              <CardDescription className="font-mono text-sm">Class XII – CBSE Board, Scored 79%</CardDescription>
            </CardHeader>
          </Card>
        </section>
      </section>
